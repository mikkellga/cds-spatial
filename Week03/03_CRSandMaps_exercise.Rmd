...
tm_shape(elevation)  +
  ...
  tm_compass(position = c("left", "top"),
             type = "rose", 
             size = 2) +
  tm_credits(text = "Mikkel Andersen, 2026") +
  tm_layout(main.title = "Denmark's Municipalities",
            bg.color = "white",
            inner.margins = c(0, 0, 0, 0))
...
places <- read_sheet("https://docs.google.com/spreadsheets/d/1PlxsPElZML8LZKyXbqdAYeQCDIvDps2McZx1cTVWSzI/edit#gid=1817942479","SA2026")
...
# /Start Code / #
head(nitrates_sf) 
# Types: S3: sfc_POINT, chr, dbl and date
# Attributes: 18 (all columns except geometry?)
# Geometry: Points
# Coordinate system: WGS 84


head(places_sf) 
# Types: S3: sfc_POINT, chr, dbl
# Attributes: 6 (all columns except geometry?)
# Geometry: Points
...
# Attributes: values i.e. elevation?
# Dimensions: 396, 876, 346896  (nrow, ncol, ncell)
# Resolution: 0.008333333, 0.008333333  (x, y)

# Plotting: Not really without defining CRS, but it would be uncertain guesses
...
```{r reproject-crs}
# /Start Code / #
nitrates4326 <- st_transform(nitrates25832, 4326)

plot(st_geometry(places4326))
plot(st_geometry(nitrates4326), add = TRUE)
...
# Exercise 6: Challenge - Make a map that lies
